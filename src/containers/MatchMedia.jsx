    ...
    return (
      <div>
        ...
        <table>
          <tr>
            <td>xs</td>
            <td className={cx('white', {
              'bg-lime': bp.xs, 'bg-red': !bp.xs,
            })}
            >{bp.xs ? 'YES' : 'NO'}</td>
